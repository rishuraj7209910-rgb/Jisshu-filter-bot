...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1002977726030").split()
]
...
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1002868310692"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1003006989628"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://Rishubotsking9:Rishubotsking9@cluster0.p2phez1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get("DATABASE_NAME", "Cluster0")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://Rishubotskihj:Rishubotskihj@cluster0.f397cca.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002988495728"))
...
# ---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/HowToOpenLinks61/3")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/HowToOpenLinks61/3")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/HowToOpenLinks61/3")
VERIFY_IMG = environ.get(
    "VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg"
)
SHORTENER_API = environ.get("SHORTENER_API", "42e316bab61945c1a9edd53e62a5623823109823")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "earnlinks.in")
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "42e316bab61945c1a9edd53e62a5623823109823"
)
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "earnlinks.in")
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "42e316bab61945c1a9edd53e62a5623823109823"
)
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://graph.org/file/493e6b664fc531f210074-04b55d01c3abc10cf0.jpg https://graph.org/file/bfea54d7a2c920860331c-63660eeff49b2b3498.jpg",
    )
).split()
FORCESUB_IMG = environ.get("FORCESUB_IMG", "https://graph.org/file/a6d49505fe90bc492e0f7-b0a9ffcd46a4400534.jpg")
REFER_PICS = (environ.get("REFER_PICS", "https://graph.org/file/9a831688fc17466dfdc0a-486f5c24d906ed811b.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://graph.org/file/cd8a38a7faf563e66fd99-9b0d740742deeaa30a.jpg")
).split()
SUBSCRIPTION = environ.get(
    "SUBSCRIPTION", "https://graph.org/file/cd8a38a7faf563e66fd99-9b0d740742deeaa30a.jpg"
)
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
